...
const configs = {
    caminho: "../index.js", //Aqui será definido a pasta de saída onde contém o index.html e os outros arquivos.
...
app.get("*", (req, res) => {// O wildcard '*' serve para servir o mesmo index.html independente do caminho especificado pelo navegador.
    res.sendFile(path.join(__dirname, configs.caminho, "index.js"));
});
